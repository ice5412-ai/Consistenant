...
namespace UnityCommunity.UnitySingleton
{
    ...
    public abstract class MonoSingleton<T> : MonoBehaviour, ISingleton where T : MonoSingleton<T>
    {
        ...
        {
            //Call DestroyInstance to set instance to default(null) to avoid Leaked Managed Shells when singleton is destroyed
            //https://docs.unity.cn/Packages/com.unity.memoryprofiler@1.1/manual/managed-shell-objects.html
            DestroyInstance();
        }
